...
CREATE TABLE IF NOT EXISTS `op_plugin` (
  `iId` int(11) NOT NULL COMMENT 'plugin 主键',
  `vPname` varchar(60) COLLATE utf8_unicode_ci NOT NULL COMMENT 'plugin 名称',
  PRIMARY KEY (`iId`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='插件表';
