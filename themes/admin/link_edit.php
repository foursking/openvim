...
<div class="col-sm-5">
<input class="form-control" id="name" name="name" size="50" type="text" value="<?php echo $link['name']?>" /></div></div>
<div class="form-group email optional">
<label class="col-sm-3 control-label" for="url">网址</label>
<div class="col-sm-5">
<input class="form-control" id="url" name="url" size="50" type="email" value="<?php echo $link['url']?>" /></div></div>
...
<div class="col-sm-offset-3 col-sm-9">
  <button type="submit" name="commit" class="btn btn-primary">更新链接</button>
</div>
</div>
</form>
</div>
